package gateway.filter.logging;

import cn.hutool.core.date.DateUnit;
import cn.hutool.core.date.DateUtil;
import cn.hutool.json.JSONUtil;
import gateway.util.SecurityFrameworkUtils;
import gateway.util.WebFrameworkUtils;
...
public class AccessLogFilter implements GlobalFilter, Ordered {
    ...
    private void writeAccessLog(AccessLog gatewayLog) {
        ...
        values.put("requestBody", JSONUtil.isJson(gatewayLog.getRequestBody()) ? // 保证 body 的展示好看
        ...
        values.put("responseBody", JSONUtil.isJson(gatewayLog.getResponseBody()) ? // 保证 body 的展示好看
        ...
        return new ServerHttpResponseDecorator(response) {
            ...
            public Mono<Void> writeWith(Publisher<? extends DataBuffer> body) {
                if (body instanceof Flux) {
                    ...
                    gatewayLog.setDuration((int) DateUtil.between(gatewayLog.getEndTime(), gatewayLog.getStartTime(), DateUnit.MS));
                    // 设置其它字段
