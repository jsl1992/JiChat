package com.ji.jichat.mybatis.core.handler;
...
public class DefaultDBFieldHandler implements MetaObjectHandler {
    ...
    public void insertFill(MetaObject metaObject) {
        if (Objects.nonNull(metaObject) && metaObject.getOriginalObject() instanceof BaseDO) {
            ...
            if (Objects.nonNull(userId) && Objects.isNull(baseDO.getCreateUser())) {
                baseDO.setCreateUser(userId.toString());
            }
            // 当前登录用户不为空，更新人为空，则当前登录用户为更新人
            if (Objects.nonNull(userId) && Objects.isNull(baseDO.getUpdateUser())) {
                baseDO.setUpdateUser(userId.toString());
            }
        }
    }
    ...
    public void updateFill(MetaObject metaObject) {
        ...
        if (Objects.nonNull(userId) && Objects.isNull(modifier)) {
            setFieldValByName("updateUser", userId.toString(), metaObject);
        }
    }
}
