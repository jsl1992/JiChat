...
import com.ji.jichat.web.util.HttpUtil;
import com.ji.mall.common.framework.exception.GlobalException;
import com.ji.mall.common.framework.exception.ServiceException;
import com.ji.mall.common.framework.exception.enums.GlobalErrorCodeConstants;
import com.ji.mall.common.framework.exception.util.MallUtils;
import com.ji.mall.common.framework.vo.CommonResult;
import com.ji.mall.systemservice.rpc.systemlog.dto.SystemExceptionLogCreateDTO;
...
import static com.ji.mall.common.framework.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static com.ji.mall.common.framework.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
...
//    private SystemExceptionLogRpc systemExceptionLogRpc;
    ...
    public CommonResult illegalArgumentExceptionHandler(IllegalArgumentException ex) {
        ...
        return CommonResult.error(GlobalErrorCodeConstants.SERVICE_ERROR.getCode(), ex.getMessage())
                .setDetailMessage(ExceptionUtil.getRootCauseMessage(ex));
    }
...
//            EXCEPTION_COUNTER.increment();
            ...
            // 执行插入 exceptionLog
            logger.info("异常信息:{}", JSON.toJSONString(exceptionLog));
        } catch (Throwable th) {
...
//    }
    ...
    private void initExceptionLog(SystemExceptionLogCreateDTO exceptionLog, HttpServletRequest request, Throwable e) {
        ...
        exceptionLog.setExceptionStackTrace(ExceptionUtil.getRootCauseMessage(e));
