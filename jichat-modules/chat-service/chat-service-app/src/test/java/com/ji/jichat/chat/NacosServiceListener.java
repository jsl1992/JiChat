...
/**
  * 监听nacos服务变化
 * 注册服务方法 post:http://192.168.137.179:8848/nacos/v1/ns/instance?serviceName=nacos.naming.serviceName&ip=20.18.7.10&port=8080
...
public class NacosServiceListener {
    ...
    public static void main(String[] args) {
        try {
            String serverAddr = "192.168.137.179:8848"; // Nacos服务器地址
            String serviceName = "chat-service"; // 服务名
            String namespace = "dev"; // 替换为实际的命名空间
