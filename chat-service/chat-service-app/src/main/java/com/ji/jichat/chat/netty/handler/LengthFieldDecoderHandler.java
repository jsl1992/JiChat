...
public class LengthFieldDecoderHandler extends LengthFieldBasedFrameDecoder {
    ...
    private static final int LENGTH_FIELD_OFFSET = 2; // 长度字段在数据帧中的偏移量
    private static final int LENGTH_FIELD_LENGTH = 2; // 长度字段的字节长度
    ...
    public LengthFieldDecoderHandler() {
        super(ByteOrder.LITTLE_ENDIAN,MAX_FRAME_LENGTH, LENGTH_FIELD_OFFSET, LENGTH_FIELD_LENGTH,LENGTH_ADJUSTMENT,INITIAL_BYTES_TO_STRIP, FAIL_FAST);
    }
